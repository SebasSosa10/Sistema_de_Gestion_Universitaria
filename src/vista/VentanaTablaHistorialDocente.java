 ...
 * @author JOAN
 */
public class VentanaTablaHistorialDocente extends javax.swing.JFrame {

    Usuario usuario;
    ControladorGestionDocente controlador;

    public VentanaTablaHistorialDocente(Usuario usuario) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "HISTORIAL CURSO", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 3, 18), new java.awt.Color(0, 0, 0))); // NOI18N
    ...
    private void actualizarTabla() {
        DefaultTableModel modelo = new DefaultTableModel(new String[]{"CODIGO_CURSO", "JORNADA", "MATERIA",},
                controlador.getHistorialCursos().size());
        tablaCurso.setModel(modelo);
        TableModel modeloDatos = tablaCurso.getModel();
        for (int i = 0; i < controlador.getHistorialCursos().size(); i++) {
            Curso aux = controlador.getHistorialCursos().get(i);
