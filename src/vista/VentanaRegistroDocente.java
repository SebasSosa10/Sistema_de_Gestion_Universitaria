...
public class VentanaRegistroDocente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "GESTIÓN DOCENTE", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 3, 18), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Profesor.png"))); // NOI18N
        ...
        tblDocente.setBackground(new java.awt.Color(204, 204, 204));
        tblDocente.setForeground(new java.awt.Color(0, 0, 0));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        try {
            if (CamposVacios()) {
                ...
                Docente docente = new Docente(especializacion, experiencia, Corre, codigo, nombre, telefono, direccion, genero, fecha, usuario, contrasenia, NumRol.DOCENTE);
                controlador.guardarDocente(docente);
                JOptionPane.showMessageDialog(null, "Se Guardo correctamente el Docente");
                actualizarTabla();
                limpiar();
            } else {
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        String codigo = txtCodigo.getText();
        Docente aux = (Docente) controlador.buscarPersona(codigo);
        if (aux != null) {
            txtContrasenia.setText(aux.getContrasenia());
            txtDireccion.setText(aux.getDireccion());
            txtEspecializacion.setText(aux.getEspecialidad());
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        try {
            if (CamposVacios()) {
                ...
                String usuario = txtUsuario.getText();
                String contrasenia = txtContrasenia.getText();
                Docente docente = new Docente(especializacion, experiencia, codigo, codigo, nombre, telefono, direccion, genero, fecha, usuario, contrasenia, NumRol.DOCENTE);
                controlador.modificarDocente(docente);
                JOptionPane.showMessageDialog(null, "Se modifico correctamente el Docente");
                actualizarTabla();
                limpiar();
            } else {
                JOptionPane.showMessageDialog(null, "Favor no dejar Campos VACIOS");
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(null, "Se elimino correctamente el Docente");
            actualizarTabla();
            limpiar();
    ...
    private void actualizarTabla() {
        listaDocente = new Lista<>();
        for (int i = 0; i < controlador.getListaPersona().size(); i++) {
            if (controlador.getListaPersona().get(i).getRol().equals(NumRol.DOCENTE)) {
                listaDocente.add((Docente) controlador.getListaPersona().get(i));
            }
        }
        ...
        TableModel modeloDatos = tblDocente.getModel();
        for (int i = 0; i < listaDocente.size(); i++) {
            Docente aux = (Docente) listaDocente.get(i);
            ...
            modeloDatos.setValueAt(aux.getEspecialidad(), i, 5);
    ...
    public boolean CamposVacios() {
        ...
        if (txtNombre.getText().isEmpty() || txtCodigo.getText().isEmpty() || txtContrasenia.getText().isEmpty() || txtDireccion.getText().isEmpty()
                || txtEspecializacion.getText().isEmpty() || txtExperiencia.getText().isEmpty() || txtTelefono.getText().isEmpty() || txtUsuario.getText().isEmpty() || cbxGenero.getSelectedIndex() == -1
