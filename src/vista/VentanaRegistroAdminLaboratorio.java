...
import Util.IList;
import Util.Lista;
import controladores.ControladorAdminLaboratorio;
 ...
 * @author JOAN
 */
public class VentanaRegistroAdminLaboratorio extends javax.swing.JFrame {

    ControladorAdminLaboratorio controlador;
    IList<AdminLaboratorio> listaAdminLaboratorio;

    public VentanaRegistroAdminLaboratorio() {
        initComponents();
        setLocationRelativeTo(this);
        this.controlador = new ControladorAdminLaboratorio();
    ...
    private void initComponents() {
        ...
        tblAdminLaboral = new javax.swing.JTable();
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "GESTIÓN ADMIN LABORATORIO", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 3, 18), new java.awt.Color(0, 0, 0))); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addGap(18, 18, 18)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(txtEspecializacion, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(txtExperiencia, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE)))))
        ...
        jTabbedPane1.addTab("AdminLaboratorio", jPanel1);

        jPanel2.setBackground(new java.awt.Color(204, 204, 204));

        tblAdminLaboral.setBackground(new java.awt.Color(204, 204, 204));
        tblAdminLaboral.setForeground(new java.awt.Color(0, 0, 0));
        tblAdminLaboral.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tblAdminLaboral);
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        try {
            if (CamposVacios()) {
                ...
                AdminLaboratorio adminLaboratorio = new AdminLaboratorio(especializacion, experiencia, codigo, nombre, telefono, direccion, genero, fecha, usuario, contrasenia, NumRol.ADMINLABORATIRIO);
                controlador.guardarAdminLaboratorio(adminLaboratorio);
                JOptionPane.showMessageDialog(null, "Se Guardo correctamente el Administrador del Laboratorio");
                actualizarTabla();
                limpiar();
            } else {
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        String codigo = txtCodigo.getText();
        AdminLaboratorio aux = (AdminLaboratorio) controlador.buscarPersona(codigo);
        if (aux != null) {
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        try {
            if (CamposVacios()) {
                ...
                String contrasenia = txtContrasenia.getText();
                AdminLaboratorio adminLaboratorio = new AdminLaboratorio(especializacion, experiencia, codigo, nombre, telefono, direccion, genero, fecha, usuario, contrasenia, NumRol.ADMINLABORATIRIO);
                controlador.modificarAdminLaboratorio(adminLaboratorio);
                JOptionPane.showMessageDialog(null, "Se modifico correctamente el Administrador del Laboratorio");
                actualizarTabla();
                limpiar();
            } else {
                JOptionPane.showMessageDialog(null, "Favor no dejar Campos VACIOS");
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        try {
            String codigo = txtCodigo.getText();
            controlador.eliminarAdminLaboratorio(codigo);
            JOptionPane.showMessageDialog(null, "Se elimino correctamente el Administrador del Laboratorio");
            actualizarTabla();
            limpiar();
    ...
    private void actualizarTabla() {
        listaAdminLaboratorio = new Lista<>();
        for (int i = 0; i < controlador.getListaPersona().size(); i++) {
            if (controlador.getListaPersona().get(i).getRol().equals(NumRol.ADMINLABORATIRIO)) {
                listaAdminLaboratorio.add((AdminLaboratorio) controlador.getListaPersona().get(i));
            }
        }
        DefaultTableModel modelo = new DefaultTableModel(new String[]{"NOMBRE", "CODIGO", "TELEFONO", "DIRECCION",
            "GENERO", "ESPECIALIZACION", "EXPERIENCIA", "EDAD"},
                listaAdminLaboratorio.size());
        tblAdminLaboral.setModel(modelo);
        TableModel modeloDatos = tblAdminLaboral.getModel();
        for (int i = 0; i < listaAdminLaboratorio.size(); i++) {
            if (listaAdminLaboratorio.get(i).getRol().equals(NumRol.ADMINLABORATIRIO)) {
                AdminLaboratorio aux = listaAdminLaboratorio.get(i);
    ...
    private javax.swing.JTable tblAdminLaboral;
